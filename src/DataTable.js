        ...
        <div className='container pt-5'>
            <div className='row' >
                ...
                <div className="col-12">
                    <button onClick={upKeyPressed}>Up</button>
                    <button onClick={downKeyPressed}>Down</button>

                    <button onClick={leftKeyPressed}>Left</button>
                    <button onClick={rightKeyPressed}>Right</button>
                </div>
            </div>
